...
function Landing() {
    return (
        <div className="d-flex flex-column align-items-center justify-content-evenly body_bg">  
            <div className="container-fluid w-75 p-5 mt-4 d-flex flex-column container_bg rounded-4">
                <div className="container mb-3 mt-4">                
                        <Image className="plotter-banner" src="https://plotter-medi-0814.s3.us-east-2.amazonaws.com/1006.png" />
                        <p className="poetsen tagline fs-1 text-center text-nowrap">a new way to locate</p>
                </div>
                <div className="d-flex flex-column flex-sm-column flex-lg-row text-center">
            ...
            <div className="container-fluid w-75 p-5 mt-4 d-flex flex-column container_bg rounded-4 align-items-center mb-5">        
                <h1 className="poetsen fs-1 text-center text-nowrap tagline signup">ready to join plotter?</h1>
                <Link to={"/signup/"}><Button className="mt-4 button_bg">SIGN UP</Button></Link>
            </div>
        </div>
