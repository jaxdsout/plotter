    ...
    return (
        <div className="flex flex-col items-center justify-evenly animator">  
            {!imageLoad ? (
                ...
                <div className="w-11/12 max-w-[600px] p-7 mt-5 mb-10 flex flex-col bg-[#e4e0d9] border-2 border-solid border-[#e1ddd6] shadow-inner-sm flex flex-col items-center justify-center rounded-md">
