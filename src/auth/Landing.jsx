            ...
            <div className="w-3/4 max-w-[800px] p-5 mt-5 flex flex-col bg-[#26282B] shadow-inner shadow-md rounded-lg">
                ...
                <div className="flex flex-col lg:flex-row text-center">
                    <div className="flex flex-col px-4">
                        <p className="text-white">At Atlas, our mission is to streamline the apartment locating process for real estate agents. Instead of juggling multiple platforms or outdated tools, Plotter is designed to be your one-stop shop for finding the perfect home. </p>
                    ...
                    <div className="flex flex-col px-4">
                        <p className="text-white">The second pillar is our powerful list-making feature—the true workhorse of Atlas. While in list mode, you can browse properties across your region, select units, and add any important details, such as specials or notes. When you're ready to send, Plotter packages everything into a unique, shareable link for your client.</p>
                        <Image src="https://plotter-medi-0814.s3.us-east-2.amazonaws.com/1009.png"/>  
                        <p className="text-white">The third pillar is deals. Once you've found your client the perfect place, it’s crucial to track their lease details and stay on top of deadlines. Atlas' deal-tracking tools notify you about important updates, so nothing slips through the cracks.</p>
                    </div>
                    <div className="flex flex-col px-4">
                        ...
                        <p className="text-white">Atlas is 100% free for licensed real estate agents. Simply sign up, provide your TREC details after activating your account, and a member of our team will confirm everything. Once verified, you're all set to start plotting full-time! </p>
                    </div>
                </div>
