...
export default function Dash () {
    ...
    return (
        <div className='flex flex-col md:flex-row items-center justify-start md:items-start md:justify-center  overflow-y-scroll overflow-x-hidden md:overflow-y-hidden w-full max-h-[48rem]'>
